...
let sanintizeHTML = require('sanitize-html')
...
let connectionString = 'mongodb+srv://todoAppUser:todoAppUser@cluster0-07akw.mongodb.net/TodoApp?retryWrites=true&w=majority'
...
app.post('/create-item', function(req, res){
  let safeText = sanintizeHTML(req.body.text, {allowedTags: [], allowedAttributes: {}})
